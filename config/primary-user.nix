...
in {
  options = {
    remi-nix.primaryUser = rec {
      ...
      fullName = mkOption {
        type = types.str;
        default = "Remi Gelinas";
      };

      email = mkOption {
        type = types.str;
        default = "mail@remigelin.as";
      };
      ...
      gpgKey = {
        ...
        subkeys = {
          ...
          encryption = mkOption {
            type = types.str;
            default = "A799 BCF5 EC76 C262 6E83  1B8E 412F D0A8 04B6 C182";
          };
          signing = mkOption {
            type = types.str;
            default = "E029 B3CB B21F 86F3 0842  BC80 F953 929D 57EC BAC0";
          };
        };
